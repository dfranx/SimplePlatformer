...
namespace gm
{
	...
	const int MaxTextureSize = 490;
	const int TileSize = 70;

	const float MaxXVelocity = 1024; // 1024 px/s
	const float AccelerationX = 3072; // player will gain 3072px/s in velocity after one second (meaning it wil reach its max velocity after 1/3 of a second)
	...
	const float PhysicsStep = 1 / 60.f;
}
